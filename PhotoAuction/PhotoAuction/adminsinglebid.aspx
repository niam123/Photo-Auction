r<%@ Page Title="Single auction item" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adminsinglebid.aspx.cs" Inherits="PhotoAuction.adminsinglebid" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <div class="container">     
           <div class="row" style="margin-top:10px;">
               <div class="col-md-10">
               <a href="adminpage.aspx" class="btn btn-primary" >Back to Previous</a>   
                </div>
               <div class="col-md-2">
